...
public class Enemy {
    ...
    public Enemy(int id, String name, int health, int max_health, int attack, int defense, int min_speed, int max_speed, int action_order, int evasion, int cost, int evadereduction, boolean alive, boolean issneak) {
        this.id = id;
        this.name = name;
        this.health = health;
